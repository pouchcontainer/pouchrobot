...
// baiduTranslator is baidu translator class
// Baidu API link: https://fanyi-api.baidu.com/api/trans/product/apidoc#joinFile
...
func (bt baiduTranslator) Translate(text string, withOrigin bool) string {
	// get each line first
